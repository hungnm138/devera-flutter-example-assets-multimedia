import 'loading_images/cached_network_asset_icon_viewer.dart';
import 'loading_images/local_asset_icon_viewer.dart';
import 'loading_images/network_asset_icon_viewer.dart';
import 'loading_svg_files/downloader_with_error_handling/web_svg_icon_viewer.dart';
import 'loading_svg_files/local_svg_icon_viewer.dart';
import 'music_playback/music_player.dart';
import 'package:flutter/material.dart';

import 'video_playback/video_loader.dart';
...
class MyApp extends StatelessWidget {
  static const String _url = "https://i.ibb.co/g9xNY1k/Devera-Logo.png";

  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Flutter Assets Examples',
      theme: ThemeData(
